class AnnouncementsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @announcement.update(announcement_params)
        format.html { redirect_to @announcement, notice: "Announcement was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to announcements_path, notice: "Announcement was successfully destroyed.", status: :see_other }
